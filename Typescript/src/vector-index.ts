import { isColumnarChunkData } from "./secret-storage.ts";
import { cosineSimilarity, cosineSimilarityAt, l2Norm, l2Normalize, pushTopK } from "./vector-math.ts";
import { cacheVectorIndex, loadVectorIndex, persistVectorIndex } from "./vector-index-store.ts";
import type {
  MEKernelLike,
  MEVectorIndex,
