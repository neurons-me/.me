import { handleCall as handleCallFn } from "./handleCall.ts";
import { ME_EXPRESSION_SYMBOL, ME_IDENTITY_SYMBOL, ME_RESEED_SYMBOL, ME_SET_ACTIVE_EXPRESSION_SYMBOL } from "./kernel-symbols.ts";
import { isMemory, splitPath } from "./operators.ts";
import type {
  EncryptedBlob,
  Memory,
  MEKernelLike,
