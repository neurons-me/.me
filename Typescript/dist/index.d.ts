...
import { createThisMe, ThisMeInput } from './src/factory.ts';
import { canonicalizeLegacyAtOperator, canonicalizeHumanIdentity, formatCanonicalMeUri, normalizeCanonicalHandle, normalizeCanonicalSpace, parseCanonicalMeUri, parseMeUri, projectDnsHostToNamespace, tryParseMeUri } from './src/me-uri.ts';
import { MEOptions } from './src/types.ts';
...
export type { DiskStoreOptions, InstanceStore, } from './src/instance-store.ts';
