...
`.me` is a callable semantic kernel. You **build meaning** with paths, add privacy structurally, and compute derived state without leaving the same object.
...
- [Memory](./Memory.html)
- [Social Graph Walkthrough](./examples/Social_Graph.html)
