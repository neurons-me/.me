...
FileTarget`tests/Builds/cjs.test.cjs`CommonJS runtime`tests/Builds/esm.test.mjs`ES Module runtime`tests/Builds/umd.test.cjs`UMD/global runtime`tests/Builds/umd.html`Manual browser UMD smoke page`tests/Builds/ts.test.ts`Type-level import usage check## What They Validate ​
