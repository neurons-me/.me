...
SurfacePurposeHow you use it**Class API**Inspection, snapshots, debugging`me.inspect()`, `me.explain()`**Callable Proxy**Main semantic language`me.profile.name()`, `me("path")`**Reflective Plane** `me["!"]`Meta-control and deep introspection`me["!"].snapshot.export()`### Class API ​
...
- [API Overview](/.me/Typescript/typedocs/api/)
- [ME Class](/.me/Typescript/typedocs/api/classes/ME.html)
