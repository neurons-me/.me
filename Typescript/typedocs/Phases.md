...
> Note: This page documents the semantic/runtime phases `0–8`. The separate performance delivery phases (storage, bounded residency, exact search, IVF) are summarized in [Kernel Benchmarks](/.me/Typescript/typedocs/kernel/Benchmarks.html).
...
me.fleet["trucks[efficiency  x.efficiency * 1.2]");
```
