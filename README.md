...
|---|---|---|---|
| <picture><source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/neurons-me/neurons-me/main/media/this.me_dark.png"><img src="https://raw.githubusercontent.com/neurons-me/neurons-me/main/media/this.me_light.png" width="64" align="left" style="margin-right:8px;border-radius:6px;"></picture> Install `.me`. | <img src="https://raw.githubusercontent.com/neurons-me/neurons-me/main/media/robots.png" width="64" align="left" style="margin-right:8px;border-radius:6px;"> · 🤖 Robots <br>· 🏙️ Smart Cities <br>· 🌐 Hemisphere Graphs | Real numbers on O(K) propagation at scale. | The infinite proxy — write `me.anything`, no schema. |
