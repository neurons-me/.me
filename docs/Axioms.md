---
layout: readme
title: The Axioms of .me
---


# 𓋹 The Axioms of .me

In **.me**, axioms are the fundamental invariants of the kernel — the unbreakable rules that the runtime must always respect on top of its [Primitives](./Primitives.html).
